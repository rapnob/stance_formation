...
def parse_arguments():
    ...
    parser.add_argument('input_cp_urls_n2p_before_overtime_pickle', type=str)
    parser.add_argument('input_cp_urls_n2a_before_overtime_pickle', type=str)
...
n2p_overtime2 = pd.read_pickle(args.input_cp_urls_n2p_before_overtime_pickle)
n2a_overtime2 = pd.read_pickle(args.input_cp_urls_n2a_before_overtime_pickle)
...
df_dict = {
    'posi': [pd.DataFrame(n2p_overtime2[month_i],columns=['target','type']) for month_i in range(5)],
