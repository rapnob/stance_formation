...
path = '/data/str01_03/twitter/hisamits/data/youtube/2021-06to08_T/concat/2021-06to08_values_url_with_label.csv'
df_06to08=pd.read_csv(path, nrows=nrows).loc[:, fields]

path = '/data/str01_03/twitter/hisamits/data/youtube/2021-09to10_T/concat/2021-09to10_values_url_with_label.csv'
